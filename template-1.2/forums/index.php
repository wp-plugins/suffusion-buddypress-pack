				...
				<?php if ( is_user_logged_in() ) : ?>
					...
					<?php if ( bp_has_groups( 'user_id=' . bp_loggedin_user_id() . '&type=alphabetical&max=100&per_page=100' ) ) : ?>
						...
						<form action="" method="post" id="forum-topic-form" class="standard-form">
							...
							<p>
							<label for='topic_text' class='textarea'><?php _e( 'Content:', 'buddypress' ) ?></label>
							...
							<div>
								...
								<input type="button" name="submit_topic_cancel" id="submit_topic_cancel" class='button' value="<?php _e( 'Cancel', 'buddypress' ) ?>" />
							</div>
