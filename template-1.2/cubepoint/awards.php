	...
	<div id="content">
		...
		<div <?php suffusion_bp_content_class(); ?>>
			...
			<div id="item-body">
				...
				echo '<p align="center">';
				echo '<a href="javascript:groups()" class="cbawardslnk">Groups</a> ';
				echo '<a href="javascript:friends()" class="cbawardslnk">Friends</a> ';
				echo '<a href="javascript:postingupdate()" class="cbawardslnk">Posting Updates</a> ';
				echo '<a href="javascript:Replies()" class="cbawardslnk">Replies</a> ';
				echo '<a href="javascript:GroupForumTopic()" class="cbawardslnk">Group Forum Topics</a> ';
				echo '<a href="javascript:GroupForumReplies()" class="cbawardslnk">Group Forum Replies</a><br /><br />';
				echo '<a href="javascript:Comments()" class="cbawardslnk">Comments</a> ';
				echo '<a href="javascript:Blogger()" class="cbawardslnk">Blog Posts</a> ';
				echo '<a href="javascript:BloggerCat()" class="cbawardslnk">Blog Posts in a Category</a> ';
				echo '<a href="javascript:Donation()" class="cbawardslnk">Donations</a> ';
				echo '<a href="javascript:Loggingin()" class="cbawardslnk">Logging In</a> ';
				echo '<a href="javascript:PointLevels()" class="cbawardslnk">Points</a> ';
				if(get_option('bp_spf_support_onoff_cp_bp')) { echo '<a href="javascript:SPFForum()" class="cbawardslnk">Main Forum</a>';}
				echo '</p><br />';
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_groupcountearn.' of '.$bp_cp_groupcounttotal.' unlocked</p>';
				echo '</div>';
				// Friends Awards
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_friendearn.' of '.$bp_cp_friendtotal.' unlocked</p>';
				echo '</div>';
				// Update Awards			
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_updateearn.' of '.$bp_cp_updatetotal.' unlocked</p>';
				echo '</div>';
				// Replies Awards
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_repliesearn.' of '.$bp_cp_repliestotal.' unlocked</p>';
				echo '</div>';
				// Forum Topic Awards
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_gforumtopicearn.' of '.$bp_cp_gforumtopictotal.' unlocked</p>';
				echo '</div>';
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_gforumreplyearn.' of '.$bp_cp_gforumreplytotal.' unlocked</p>';
				echo '</div>';
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_blogcommentearn.' of '.$bp_cp_blogcommenttotal.' unlocked</p>';
				echo '</div>';
				// Blog Posts Awards
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_bloggerearn.' of '.$bp_cp_bloggertotal.' unlocked</p>';
				echo '</div>';
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_blogcatearn.' of '.$bp_cp_blogcattotal.' unlocked</p>';
				echo '</div>';
				// Donation Awards
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_donationearn.' of '.$bp_cp_donationtotal.' unlocked</p>';
				echo '</div>';
				/* Daily Login */
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_dailyloginearn.' of '.$bp_cp_dailylogintotal.' unlocked</p>';
				echo '</div>';
				/* Point Levels */
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_pointsearn.' of '.$bp_cp_pointstotal.' unlocked</p>';
				echo '</div>';
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_spfpostsearned.' of '.$bp_cp_spfpoststotal.' unlocked</p>';
			}
				echo '</div>';
				...
				echo '<p class="cbbpimgawards" align="center">'.$bp_cp_total_awards.' '.get_option('bp_awards_menutitle_cp_bp').' Earned';
				echo '<br />'.$bp_cp_total_awardsNO.' '.get_option('bp_awards_menutitle_cp_bp').' Total</p>';
				?>
