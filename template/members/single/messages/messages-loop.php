...
<?php if ( bp_has_message_threads() ) : ?>
	...
	<table id="message-threads">
		...
		<?php $odd_even = ++$ctr%2 == 1 ? ' odd ' : ' even '; ?>

			<tr id="m-<?php bp_message_thread_id() ?>"<?php if ( bp_message_thread_has_unread() ) : ?> class="<?php echo $odd_even; ?> unread"<?php else: ?> class="<?php echo $odd_even; ?> read"<?php endif; ?>>
